...
close_price = 200.0 - float(ast.literal_eval(requests.get(f"https://testnet-master-1.lamden.io/contracts/currency/balances?key={new_wallet.verifying_key}").decode("UTF-8"))['value']['__fixed__'])
